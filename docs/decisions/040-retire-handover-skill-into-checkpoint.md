...
4. ドキュメント（README(.ja).md / SPEC.md / spec/api.md / spec/architecture.md / rl-anything-advisor.md）から handover 行を除去。
...
- 公開コマンド `/rl-anything:handover` が消えるため利用者影響あり → MINOR bump 相当。
