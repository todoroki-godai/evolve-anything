...
self_analysis: {
  ...
  improvement_opportunities: {candidates: [...], summary_line: "..."}, # 系統的却下 type / calibration regression / 整合性 drift（契約乖離・usage↔suitability 矛盾 #377-5）/ measurement_bug（PJ横断bit-exact一致 #324）
  total_candidates: N,
}
```
