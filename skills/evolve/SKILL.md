...
python3 "${CLAUDE_PLUGIN_ROOT}/scripts/lib/world_context.py" --load --slug "$SLUG" 2>/dev/null || \
  python3 "${CLAUDE_PLUGIN_ROOT}/scripts/lib/world_context.py" --generate --claude-md CLAUDE.md \
    --slug "$SLUG"
```
